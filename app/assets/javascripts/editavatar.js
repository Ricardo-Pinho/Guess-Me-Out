...
$(document).ready(function() {
	if ($("svg").length>0)
	{
		...
		avatar=parseInt($("svg:eq("+0+")").attr('id'));
		if (avatar>0)
		{
			...
			if ($(".editsvg").length>0)
			{
				var user=parseInt($(".editsvg:eq("+0+")").attr('data-user'));
