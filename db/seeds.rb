...
Componenttype.create!(:component_id=> 6, :name => 'NormalNose', :color => 1, :price => 0, :svg => '<path id="path3891-9" fill="#513421" d="M209.737,187.787c0,0-3.931,13.925-6.063,20.6c-1.037,3.246-14.592,20.881-13.559,23.807c1.032,2.927,22.72,4.819,22.72,4.819s3.786-21.515,3.098-28.571S209.737,187.787,209.737,187.787z"/>')

Componenttype.create!(:component_id=> 7, :name => 'NormalMouth', :color => 1, :price => 0, :svg => '<path id="Mouth-0" fill="#FFFFFF" fill-opacity="0.9647" d="M265.841,260.849c0,0-61.926,13.35-73.421,12.236 c-11.495-1.112-35.969-22.248-35.969-22.248s17.799,28.923,33.744,31.519C206.139,284.951,265.841,260.849,265.841,260.849z"/>')
