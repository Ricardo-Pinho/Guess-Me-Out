...
Componenttype.create!(:component_id=> 5, :name => 'noMoustache', :color => 2, :price => 0, :svg => '')

Componenttype.create!(:component_id=> 6, :name => 'NormalNose', :color => 0, :price => 0, :svg => '<path id="path3891-9" fill="#513421" d="M209.737,187.787c0,0-3.931,13.925-6.063,20.6c-1.037,3.246-14.592,20.881-13.559,23.807c1.032,2.927,22.72,4.819,22.72,4.819s3.786-21.515,3.098-28.571S209.737,187.787,209.737,187.787z"/>')

Componenttype.create!(:component_id=> 7, :name => 'NormalMouth', :color => 0, :price => 0, :svg => '<path id="Mouth-0" fill="#FFFFFF" fill-opacity="0.9647" d="M265.841,260.849c0,0-61.926,13.35-73.421,12.236 c-11.495-1.112-35.969-22.248-35.969-22.248s17.799,28.923,33.744,31.519C206.139,284.951,265.841,260.849,265.841,260.849z"/>')

Componenttype.create!(:component_id=> 8, :name => 'PlainShirt', :color => 1, :price => 0, :svg => '<path id="path25" fill="#C42C2C" d="M76.5,487.5c0,0-5-28,13.5-59s63.391-50.771,87.03-58.061 c23.47-7.238,36.53-13.172,36.53-13.172s-3.277,9.646-6.939,27.556C202.589,404.546,215.5,417,232.5,417.5s48.744-6.983,73.854-22.5 c24.494-15.138,37.432-42.771,37.237-43.207c0,0,11.208,10.894,24.247,16.01c23.03,9.036,45.359,18.337,62.161,31.697 c16.9,13.438,45.613,58.53,49.401,76.917c0.195,0.947-53.109,22.958-81.401,37.083L113,513L76.5,487.5z"/>')
